...
def get_stats_markup(_, status):
    ...
    sudo = [
        InlineKeyboardButton(text=_["SA_B_8"], callback_data="bot_stats_sudo g"),
        InlineKeyboardButton(text=_["CLOSEMENU_BUTTON"], callback_data="close")
    ]
    upl = InlineKeyboardMarkup(
        [
            ...
            [
                ...
                InlineKeyboardButton(text=_["SA_B_5"], callback_data="TopOverall g")
            ],
...
def stats_buttons(_, status):
    not_sudo = [
        InlineKeyboardButton(text=_["SA_B_5"], callback_data="TopOverall s")
    ]
    sudo = [
        InlineKeyboardButton(text=_["SA_B_8"], callback_data="bot_stats_sudo s"),
        InlineKeyboardButton(text=_["SA_B_5"], callback_data="TopOverall s")
    ]
    upl = InlineKeyboardMarkup(
        [
